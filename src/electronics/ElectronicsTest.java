...
public class ElectronicsTest extends Utility {
    ...
    public void verifyUserShouldNavigateToCellPhonesPageSuccessfully() {
        ...
        assertVerifyText(actualText, "Cell phones");
    }
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        assertVerifyText(actualText1, "Nokia Lumia 1020");
        ...
        assertVerifyText(actualPrice, "$349.00");
        ...
        assertVerifyText(actualMessage, "The product has been added to your shopping cart");
        ...
        assertVerifyText(actualMessage1, "Shopping cart");
        Thread.sleep(2000);
        ...
        assertVerifyText(actualMessage3, "Welcome, Please Sign In!");
        ...
        assertVerifyText(actualMessage4, "Register");
        Thread.sleep(2000);

        // 2.19 Fill the mandatory fields
        //First name
        sendTextToElement(By.xpath("//input[@id='FirstName']"), "Milton");
        //Last name
        sendTextToElement(By.xpath("//input[@id='LastName']"), "Smith");
        // Email
        String randomEmail = randomEmail();
        sendTextToElement(By.xpath("//input[@id='Email']"), randomEmail);
        // Password
        sendTextToElement(By.xpath("//input[@id='Password']"), "smith123456");
        // Confirm password
        sendTextToElement(By.xpath("//input[@id='ConfirmPassword']"), "smith123456");
        ...
        assertVerifyText(actualMessage5, "Your registration completed");
        ...
        System.out.println(driver.findElement(By.xpath("//h1[contains(text(),'Shopping cart')]")).getText());
        assertVerifyText(actualMessage6, "Shopping cart");
        Thread.sleep(2000);
        ...
        // name
        sendTextToElement(By.xpath("//input[@id='CardholderName']"), "John");
        //Card number
        ...
        // card code
        sendTextToElement(By.xpath("//input[@id='CardCode']"), "089");
        ...
        assertVerifyText(actualMessage8, "Payment Method: Credit Card");
        Thread.sleep(2000);
        ...
        assertVerifyText(actualMessage9, "Shipping Method: 2nd Day Air");
        Thread.sleep(2000);

        // 2.37 Verify Total is “$698.00”
        By actualMessage10 = By.xpath("//span[@class='product-subtotal']");
        System.out.println(driver.findElement(By.xpath("//span[@class='product-subtotal']")).getText());
        assertVerifyText(actualMessage10, "$698.00");
        Thread.sleep(2000);
        ...
        assertVerifyText(actualMessage11, "Thank you");
        Thread.sleep(2000);
        ...
        assertVerifyText(actualMessage12, "Your order has been successfully processed!");
        ...
        assertVerifyText(actualMessage13, "Welcome to our store");
        Thread.sleep(2000);
