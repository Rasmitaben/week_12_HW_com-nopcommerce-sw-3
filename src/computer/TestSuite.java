...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        assertVerifyText(actualText, "Build your own computer");
        ...
        assertVerifyText(actualPrice, "$1,470.00");
        ...
        assertVerifyText(actualTotal, "$2,950.00");
        Thread.sleep(2000);
        ...
        assertVerifyText(actualText1, "Welcome, Please Sign In!");
        ...
        //First name
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Stephen");
        //Last name
        ...
        //City
        sendTextToElement(By.id("BillingNewAddress_City"), "Col");
        //Address
        ...
        //name
        sendTextToElement(By.id("CardholderName"), "Magnus");
        //card number
        ...
        sendTextToElement(By.xpath("//input[@id='CardCode']"), "079");
        ...
        assertVerifyText(actualText2, "Payment Method: Credit Card");
        ...
        assertVerifyText(actualText3, "Shipping Method: Next Day Air");
        ...
        Thread.sleep(2000);
        assertVerifyText(actualText4, "$2,950.00");
        ...
        assertVerifyText(actualText5, "Thank you");
        ...
        assertVerifyText(actualText6, "Your order has been successfully processed!");
        ...
        assertVerifyText(actualText7, "Welcome to our store");
